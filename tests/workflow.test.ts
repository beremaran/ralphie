...
import { GitRepositoryInvariant } from "../src/git/repository-invariant.ts";
import { GitIssueCheckpoint } from "../src/git/issue-checkpoint.ts";
import { GitIssueOperations } from "../src/git/issue-operations.ts";
import { GitWorktrees } from "../src/git/worktree.ts";
import { GitHubClient } from "../src/github/client.ts";
import { GitHubPullRequests } from "../src/github/pull-requests.ts";
import { GitHubIssueMutations } from "../src/github/issue-mutations.ts";
import {
  GitHubIssues,
  type GitHubIssue,
  IssueOrder,
...
import { IssueExecutor } from "../src/issues/executor.ts";
import {
  IssueArtifactStore,
  makeIssueArtifactStore,
} from "../src/issues/artifacts.ts";
import { DryRunIssueExecutor } from "../src/issues/dry-run-executor.ts";
import { DEFAULT_PI_AGENT } from "../src/agent/model.ts";
import { Pi } from "../src/agent/server.ts";
import {
  ProgressReporter,
  type ProgressUpdate,
  ProgressStage,
...
function testRuntime(
  ...
  return Layer.mergeAll(
    ...
    Layer.succeed(GitWorktrees, {
      prepareIssue: ({ workspace, runId, issueNumber, branch, repository }) =>
        Effect.sync(() => {
