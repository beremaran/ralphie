...
describe("display state", () => {
    ...
    test("redacts sensitive repository, issue, and activity text", () => {
        const state = reduceProgressUpdate(undefined, {
            ...baseProgress,
        ...
        expect(next.repository).not.toContain("private-value");
        expect(next.issue?.title).not.toContain("private-value");
