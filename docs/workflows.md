...
2. Ask a fresh Codex session to implement the issue and require a schema-valid
...
1. Ask Codex to split the issue into the next set of independently actionable
