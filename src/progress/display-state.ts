...
export const PROGRESS_STAGE_LABELS: Readonly<Record<ProgressStage, string>> = {
    ...
    "maintenance-observation": "Observing maintenance state",
    "maintenance-planning": "Planning maintenance",
    "maintenance-validation": "Validating maintenance plan",
    "maintenance-action": "Selecting maintenance action",
    "maintenance-mutation": "Reconciling maintenance mutation",
    "maintenance-replan": "Replanning maintenance",
    "maintenance-outcome": "Recording maintenance outcome",
